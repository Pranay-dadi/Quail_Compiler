...
define void @Num_set(%Num* nocapture writeonly %this_arg, i32 %0) local_unnamed_addr #0 {
entry:
  %this.value.ptr = getelementptr %Num, %Num* %this_arg, i64 0, i32 0
  store i32 %0, i32* %this.value.ptr, align 4
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly willreturn
define i32 @Num_get(%Num* nocapture readonly %this_arg) local_unnamed_addr #1 {
entry:
  %this.value.ptr = getelementptr %Num, %Num* %this_arg, i64 0, i32 0
